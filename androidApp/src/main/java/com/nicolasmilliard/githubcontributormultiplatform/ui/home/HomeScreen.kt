...
import com.nicolasmilliard.githubcontributormultiplatform.ui.MyApplicationTheme
import com.nicolasmilliard.githubcontributormultiplatform.ui.home.Event
import com.nicolasmilliard.githubcontributormultiplatform.ui.home.Model


@Composable
fun HomeScreen(model: Model, onEvent: (Event) -> Unit) {
  Box(
    modifier = Modifier
      .fillMaxSize()
...
@Preview(showBackground = true)
@Composable
fun BreedStatePreview() {
  MyApplicationTheme {
    HomeScreen(
      Model(
      loading = false,
      breeds = listOf("Breed 1", "Breed 2"),
      dropdownText = "dropDownTest",
      currentUrl = null
    )
    ){}
  }
